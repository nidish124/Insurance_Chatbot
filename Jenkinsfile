...
// from AWS URL and ECR details
    environment {
        AWS_REGION = 'ap-south-1'
        ECR_REPO = 'rag_insurance'
        IMAGE_TAG = 'latest'
        SERVICE_NAME = 'llmops-insurance-service'
    }
        ...
        stage('Clone GitHub Repo') {
            steps {
                script {
                    ...
                    // from jenkins we need to copy this
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[url: 'https://github.com/nidish124/Insurance_Chatbot.git']])
                }
            }
        }
// AWS token which you mentioned in jenkins while adding credentials
